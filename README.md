...
> **¿Ya tenías la app funcionando con usuarios de una versión anterior?**
> No vuelvas a correr `supabase_schema.sql`. En su lugar, corre una sola vez
> `supabase_migration_social.sql` en el SQL Editor. Ese archivo solo AGREGA
> las funciones sociales nuevas (apodos, avatares, comentarios, reacciones)
