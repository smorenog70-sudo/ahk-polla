...
function ProgressBar({ label, played, total, color = '#2E5DA8', suffix = '' }) {
  ...
  return (
    <div className="card">
      ...
      <div className="space-y-3">
        <ProgressBar label="⚽ Partidos jugados" played={p.matches.played} total={p.matches.total} color="#2E5DA8" />
      ...
      <div className="mt-4 pt-3 border-t border-ink-700">
        ...
        <div className="space-y-2.5">
          <ProgressBar label="Marcadores" played={p.points.breakdown.match.played} total={p.points.breakdown.match.total} color="#2E5DA8" suffix=" pts" />
