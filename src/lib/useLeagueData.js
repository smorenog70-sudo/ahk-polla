 ...
 * Returns: { profiles, predictions, results, groupPreds, groupResults, thirdPreds, thirdResults, config, refresh, loading }
 */
export function useLeagueData() {
  ...
  const load = useCallback(async () => {
    ...
    const [profiles, preds, results, gp, gr, tp, tr, cfg] = await Promise.all([
