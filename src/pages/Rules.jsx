  ...
  return (
    <div className="space-y-4">
      <div className="card text-center">
        <img src="/logo.png" alt="AHK Copa Interna" className="w-28 h-28 mx-auto mb-3 rounded-full bg-white p-1" />
        <h1 className="text-xl font-bold mb-2">AHK Copa Interna</h1>
        <p className="text-ink-300 text-sm">
          Polla del Mundial 2026 — Cámara de Industria y Comercio Colombo-Alemana ⚽
        </p>
      </div>
      ...
      <div className="card">
        ...
        <p className="text-sm text-ink-300 mt-1">
          Todos los colaboradores y afiliados de AHK pueden participar sin costo. Solo necesitas crear tu cuenta con tu correo.
        </p>
      </div>
      ...
      <p className="text-center text-ink-300 text-sm py-4">
        ¡Que viva el fútbol y los lazos colombo-alemanes! 🇨🇴🇩🇪
      </p>
    </div>
  )
}
