    ...
    <div className="space-y-3 pb-20">
      ...
      <div className="grid grid-cols-3 gap-2">
        ...
        <div className="card text-center py-3">
          ...
          <div className="text-[10px] text-ink-400">sin confirmar</div>
        </div>
      </div>
      ...
      {stats.unpaid.length > 0 && (
        <div className="card">
          <h2 className="font-semibold mb-1 text-yellow-300">👋 Participación pendiente</h2>
          <div className="flex flex-wrap gap-1">
            {stats.unpaid.map(p => (
          ...
          <button
            onClick={() => copyList(stats.unpaid,
              '👋 Recordatorio: aún falta confirmar tu participación en la copa. ¡Avísale al admin!')}
            className="mt-2 text-xs bg-green-700 hover:bg-green-600 text-white rounded-lg px-3 py-1.5"
          >
            📋 Copiar lista para WhatsApp
          </button>
