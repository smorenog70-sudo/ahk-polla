    ...
    <div className="space-y-3 pb-20">
      <div className="card">
        ...
        <p className="text-xs text-ink-300">
          Datos agregados anónimos de toda la comunidad.
        </p>
      </div>
...
function OverviewView({ overview }) {
  return (
    <div className="space-y-3">
      ...
      <div className="card">
        <h3 className="font-semibold mb-2 text-accent-400">¿Qué muestra esta página?</h3>
  ...
  return (
    <div className="card">
      ...
      <div className="space-y-1.5">
        ...
        <DistroBar label={match.team2 + ' gana'} count={distribution.visitante} pct={pct(distribution.visitante)} color="bg-accent-500" />
      </div>
